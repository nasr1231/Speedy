...
namespace Speedy.Data.Migrations
{
    ...
    [Migration("20240518123541_AddPaymentMethodsTableAndRelations")]
    partial class AddPaymentMethodsTableAndRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Speedy.Core.Models.Order", b =>
                {
                    ...
                    b.HasOne("Speedy.Core.Models.PaymentMethod", null)
                        .WithMany("Order")
                        .HasForeignKey("PaymentMethodId");
